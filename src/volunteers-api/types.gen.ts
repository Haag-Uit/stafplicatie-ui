...
export type HaaguitersCreateVolunteerRequest = {
    campyearYear: number;
...
export type HaaguitersCreateVolunteerResponse = {
    volunteer?: HaaguitersVolunteerResponse;
};

export type HaaguitersGetVolunteerResponse = {
    volunteer?: HaaguitersVolunteerResponse;
};

export type HaaguitersListVolunteersResponse = {
    count?: number;
    volunteers?: Array<HaaguitersVolunteerResponse>;
};

export type HaaguitersUpdateVolunteerRequest = {
    driversLicense: 'Geen' | 'B' | 'BE';
    experience?: string;
    firstAid: 'Geen' | 'EHBO' | 'BHV';
    firstChoices: Array<string>;
...
export type HaaguitersUpdateVolunteerResponse = {
    volunteer?: HaaguitersVolunteerResponse;
};

export type HaaguitersVolunteerResponse = {
    campyearYear: number;
    driversLicense: 'Geen' | 'B' | 'BE';
    experience: string;
    firstAid: 'Geen' | 'EHBO' | 'BHV';
...
export type ListVolunteersResponses = {
     ...
     */
    200: HaaguitersListVolunteersResponse;
};
...
export type CreateVolunteerData = {
     ...
     * Volunteer data
     */
    body: HaaguitersCreateVolunteerRequest;
    path?: never;
    query?: never;
    url: '/api/v1/';
};
...
export type CreateVolunteerResponses = {
     ...
     */
    201: HaaguitersCreateVolunteerResponse;
};
...
export type GetVolunteerByPersonResponses = {
     ...
     */
    200: HaaguitersGetVolunteerResponse;
};
...
export type UpdateVolunteerData = {
     ...
     */
    body: HaaguitersUpdateVolunteerRequest;
    path: {
        /**
         * Volunteer ID
         */
...
export type UpdateVolunteerResponses = {
     ...
     */
    200: HaaguitersUpdateVolunteerResponse;
};
