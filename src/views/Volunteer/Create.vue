...
import type { CreateVolunteer } from "./volunteer.types";
import moment from "moment";

const pageTitle = ref("Medewerker aanmaken");
const volunteer = ref<CreateVolunteer>({
  person: {
    firstName: "",
    lastName: "",
    email: "",
...
const eighteenYearsAgo = new Date(today.getFullYear() - 18, 6, 15, 2, 0, 0, 0);
volunteer.value.person.dateOfBirth = eighteenYearsAgo
  .toISOString()
  .split("T")[0];
const error = ref("");
...
function create() {
  apiClient
    .post("/stafplicatie/v1/volunteer", volunteer.value)
    .then(() => {
