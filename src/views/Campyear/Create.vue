...
const pageTitle = ref("Kampjaar aanmaken");
const campyear = ref({
  year: "",
  start: "",
  end: "",
...
function createCampyear() {
  apiClient
    .post("/stafplicatie/v1/campyear", requestBody.value)
    .then((response) => {
    ...
    <div class="">
      <div class="flex flex-col gap-9">
        <DefaultCard cardTitle="Kampjaar gegevens">
          <div class="p-6.5">
            <form @submit.prevent="createCampyear">
