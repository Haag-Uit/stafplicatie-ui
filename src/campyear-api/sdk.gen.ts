...
import type { ListCampyearsData, ListCampyearsResponses, ListCampyearsErrors, CreateCampyearData, CreateCampyearResponses, CreateCampyearErrors, GetActiveCampyearData, GetActiveCampyearResponses, GetActiveCampyearErrors, DeleteCampyearData, DeleteCampyearResponses, DeleteCampyearErrors, GetCampyearData, GetCampyearResponses, GetCampyearErrors, UpdateCampyearData, UpdateCampyearResponses, UpdateCampyearErrors, ActivateCampyearData, ActivateCampyearResponses, ActivateCampyearErrors, CloseCampyearData, CloseCampyearResponses, CloseCampyearErrors, OpenCampyearData, OpenCampyearResponses, OpenCampyearErrors } from './types.gen';
 ...
 */
export const getActiveCampyear = <ThrowOnError extends boolean = false>(options?: Options<GetActiveCampyearData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetActiveCampyearResponses, GetActiveCampyearErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
